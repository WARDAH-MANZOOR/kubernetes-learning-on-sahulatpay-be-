...
import { decryptEncryptedPayoutPayload } from "../../utils/PayoutDecryption.js";

export default function (router: Router) {
  router.use(
    [
      "/jzw-disburse/:merchantId",
      "/jz-disburse-status/:merchantId",
      "/jz-disburse/:merchantId",
      "/jz-disburse-new/:merchantId",
  ...
  router.post(
    "/jzw-disburse-new/:merchantId",
    [apiKeyAuth],
    decryptEncryptedPayoutPayload,
    jazzCashController.initiateMWDisbursementNewFlow
  )
  ...
  router.post(
    ...
    [apiKeyAuth],
    decryptEncryptedPayoutPayload,
    jazzCashController.initiateDisbursmentCloneNewFlow
  )
  ...
  router.post(
    "/initiate-jza/:merchantId",
    [apiKeyAuth, ...validateJazzcashRequest, ...validateJazzcashOrderId, block_phone_number_middleware.blockPhoneNumber],
    blockPhoneMiddleware,
