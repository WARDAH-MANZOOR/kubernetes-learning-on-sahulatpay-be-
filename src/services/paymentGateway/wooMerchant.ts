...
const getWoocommerceMerchant = async (params: IjazzCashConfigParams) => {
    try {
        const where: any = {};
...
const createWoocommerceMerchant = async (merchantData: any) => {
    try {
...
const updateWoocommerceMerchant = async (merchantId: number, updateData: any) => {
    try {
...
const deleteWoocommerceMerchant = async (merchantId: number) => {
    try {
