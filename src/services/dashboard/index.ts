      ...
      const dashboardSummary = {
        ...
        easyPaisaCount:
          (easyPaisaTotal as unknown as { _count: { original_amount: number | null } })._count
            ?.original_amount || 0,
        qrTotal:
          (qrTotal as { _sum: { original_amount: number | null } })._sum
            ?.original_amount || 0,
        qrCount:
          (qrTotal as unknown as { _count: { original_amount: number | null } })._count
            ?.original_amount || 0,
        cardTotal:
          (cardTotal as { _sum: { original_amount: number | null } })._sum
            ?.original_amount || 0,
        cardCount:
          (cardTotal as unknown as { _count: { original_amount: number | null } })._count
            ?.original_amount || 0,
      };
